...
print ("Below is the code for ")
print ("Using the Data Structure to Store Data for a single game of tic tac toe Python")
...
print ("Below is the code for ")
print ("To Handle Exception and Allot the selection of the symbol for the current player for each iteration of the game ")
...
print ("Below is the code for ")
print ("Execution of the tic tac toe Python game and updating the scoreboard simultaneously ")
...
print ("Below is the code for ")
print ("Swapping the chance given to choose the symbol between the selecting player ")
